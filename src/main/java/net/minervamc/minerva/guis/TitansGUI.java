...
public class TitansGUI {
    ...
    private static ItemStack styx = ItemUtils.getItem(new ItemStack(Material.WITHER_ROSE), ChatColor.RED + "" + ChatColor.BOLD + "Styx", ChatColor.GRAY + "Become a child of Styx, titan of oaths, hatred, and the river Styx. (Requires Donator Rank)");
    private static ItemStack mnemosyne = ItemUtils.getItem(new ItemStack(Material.CANDLE), ChatColor.RED + "" + ChatColor.BOLD + "Mnemosyne", ChatColor.GRAY + "Become a child of Styx, titan of memory. (Requires Donator Rank)");
    private static ItemStack koios = ItemUtils.getItem(new ItemStack(Material.ENDER_PEARL), ChatColor.RED + "" + ChatColor.BOLD + "Koios", ChatColor.GRAY + "Become a child of Koios, titan of foresight. (Requires Donator Rank)");
    private static ItemStack rhea = ItemUtils.getItem(new ItemStack(Material.VINE), ChatColor.RED + "" + ChatColor.BOLD + "Rhea", ChatColor.GRAY + "Become a child of Rhea, titan of fertility. (Requires Donator Rank)");
    private static ItemStack prometheus = ItemUtils.getItem(new ItemStack(Material.TOTEM_OF_UNDYING), ChatColor.RED + "" + ChatColor.BOLD + "Prometheus", ChatColor.GRAY + "Become a child of Prometheus, titan of fire and the creator of humans. (Requires Donator Rank)");
